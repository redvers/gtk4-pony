...
# 41 "/usr/include/glib-2.0/glib/gthread.h"
extern
...
# 42 "/usr/include/glib-2.0/glib/gbacktrace.h"
extern
...
# 210 "/usr/include/glib-2.0/gobject/gvalue.h"
...
# 379 "/usr/include/glib-2.0/gobject/genums.h"
      ...
      char *argv[])
{
  ...
  do { if (!(((__extension__ ({ const GValue *__val = (const GValue*) ((&a)); GType __t = (((GType) ((16) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; }))))) ; else g_assertion_message_expr (((gchar*) 0), "gvalue.c", 23, ((const char*) (__func__)), "!G_VALUE_HOLDS_STRING (&a)"); } while (0);


  g_value_init (&a, ((GType) ((16) << (2))));
  do { if ((((__extension__ ({ const GValue *__val = (const GValue*) ((&a)); GType __t = (((GType) ((16) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; }))))) ; else g_assertion_message_expr (((gchar*) 0), "gvalue.c", 27, ((const char*) (__func__)), "G_VALUE_HOLDS_STRING (&a)"); } while (0);
  ...
  g_value_init (&a, ((GType) ((6) << (2))));
  g_value_set_int (&a, 42);


  g_value_init (&b, ((GType) ((16) << (2))));


  do { if (g_value_type_transformable (((GType) ((6) << (2))), ((GType) ((16) << (2))))) ; else g_assertion_message_expr (((gchar*) 0), "gvalue.c", 42, ((const char*) (__func__)), "g_value_type_transformable (G_TYPE_INT, G_TYPE_STRING)"); } while (0);

  g_value_transform (&a, &b);
  g_printf ("%s\n", g_value_get_string (&b));


  g_value_register_transform_func (((GType) ((6) << (2))), ((GType) ((16) << (2))), int2string);
  g_value_transform (&a, &b);
  g_printf ("%s\n", g_value_get_string (&b));
...
static GType my_struct_get_type_once (void); GType my_struct_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : 
# 61 "gvalue.c" 3 4
((void *)0)
# 61 "gvalue.c"
); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = my_struct_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType my_struct_get_type_once (void) { GType (* _g_register_boxed) (const gchar *, union { MyStruct * (*do_copy_type) (MyStruct *); MyStruct * (*do_const_copy_type) (const MyStruct *); GBoxedCopyFunc do_copy_boxed; } __attribute__((__transparent_union__)), union { void (* do_free_type) (MyStruct *); GBoxedFreeFunc do_free_boxed; } __attribute__((__transparent_union__)) ) = g_boxed_type_register_static; GType g_define_type_id = _g_register_boxed (g_intern_static_string ("MyStruct"), my_struct_copy, my_struct_free); { {{};} } return g_define_type_id; }
...
foo (void)
{
  GValue *value = ((GValue *) g_malloc0_n ((1), sizeof (GValue)));
  g_value_init (value, (my_struct_get_type ()));
